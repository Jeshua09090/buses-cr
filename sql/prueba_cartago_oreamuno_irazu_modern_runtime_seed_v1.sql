...
with seed_routes as (
  ...
  from (
    values
      (4430::bigint, 'ida'::text, 24::integer),
      (4431::bigint, 'vuelta'::text, 24::integer),
      (4432::bigint, 'ida'::text, 32::integer),
      (4433::bigint, 'vuelta'::text, 32::integer),
      (4434::bigint, 'ida'::text, 45::integer),
      (4435::bigint, 'vuelta'::text, 45::integer),
      (4436::bigint, 'ida'::text, 38::integer)
...
preview_stops as (
  select
    sr.ruta_id,
    sr.sentido,
    concat('preview-', sr.sentido, '-', sr.ruta_id::text, '-cartago-oreamuno-irazu-v1') as pattern_code,
    concat(r.nombre_ruta, ' / ', upper(sr.sentido)) as pattern_name,
    'local'::text as categoria_operativa,
    0.820::numeric as clasificacion_confianza,
...
where rp.ruta_id between 4430 and 4436
...
with pattern_targets as (
  ...
  join (
    values
      (4430::bigint, 24::integer),
      (4431::bigint, 24::integer),
      (4432::bigint, 32::integer),
      (4433::bigint, 32::integer),
      (4434::bigint, 45::integer),
      (4435::bigint, 45::integer),
      (4436::bigint, 38::integer)
