  ...
  from (
    values
      (
        4227::bigint,
        'ida'::text,
        'preview-ida-4227-campina-v1'::text,
...
select
  ...
  'importacion',
  jsonb_build_object(
    'seed_source', 'preview_campina_modern_v1',
...
where rp.ruta_id in (4227)
  and rp.fuente = 'importacion'
  and coalesce(rp.metadata ->> 'seed_source', '') = 'preview_campina_modern_v1';
