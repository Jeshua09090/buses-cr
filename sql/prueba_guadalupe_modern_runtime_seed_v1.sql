  ...
  from (
    values
      (
        5332::bigint,
        'loop'::text,
        'preview-loop-5332-guadalupe-lima-v1'::text,
      ...
      (
        5333::bigint,
        'loop'::text,
        'preview-loop-5333-guadalupe-joya-v1'::text,
...
select
  ...
  'importacion',
  jsonb_build_object(
    'seed_source', 'preview_guadalupe_modern_v1',
...
where rp.ruta_id in (5332, 5333)
  and rp.fuente = 'importacion'
  and coalesce(rp.metadata ->> 'seed_source', '') = 'preview_guadalupe_modern_v1';
...
with pattern_targets as (
  ...
  join (
    values
      (5332::bigint, 16::integer),
      (5333::bigint, 16::integer)
...
join lateral (
  values
    ('habil'::text, '05:30'::time, '09:00'::time, greatest(10, pt.frecuencia_base_min)),
    ('habil'::text, '09:00'::time, '16:00'::time, greatest(12, pt.frecuencia_base_min + 2)),
    ('habil'::text, '16:00'::time, '20:00'::time, greatest(10, pt.frecuencia_base_min)),
    ('sabado'::text, '06:00'::time, '19:30'::time, greatest(12, pt.frecuencia_base_min + 2)),
    ('domingo'::text, '07:00'::time, '18:30'::time, greatest(14, pt.frecuencia_base_min + 4)),
    ('feriado'::text, '07:00'::time, '18:30'::time, greatest(14, pt.frecuencia_base_min + 4))
