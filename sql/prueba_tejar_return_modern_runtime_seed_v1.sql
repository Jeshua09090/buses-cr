  ...
  from (
    values
      (
        4290::bigint,
        'vuelta'::text,
        'preview-vuelta-4290-molino-v1'::text,
        'SAN ISIDRO-CARTAGO POR EL MOLINO / VUELTA'::text,
        'local'::text,
        0.930::numeric,
        18::integer
      ),
      (
        4291::bigint,
        'vuelta'::text,
        'preview-vuelta-4291-asuncion-v1'::text,
        'SAN ISIDRO-CARTAGO POR ASUNCION / VUELTA'::text,
        'local'::text,
        0.900::numeric,
        20::integer
      )
...
select
  ...
  'importacion',
  jsonb_build_object(
    'seed_source', 'preview_tejar_return_modern_v1',
...
where rp.ruta_id in (4290, 4291)
  and rp.fuente = 'importacion'
  and coalesce(rp.metadata ->> 'seed_source', '') = 'preview_tejar_return_modern_v1';
...
with pattern_targets as (
  ...
  join (
    values
      (4290::bigint, 18::integer),
      (4291::bigint, 20::integer)
