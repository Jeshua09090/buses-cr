...
-- Adaptador fase 1 GTFS-like:
-- Reemplaza la RPC v2 para leer primero de route_patterns, route_pattern_stops
-- y service_windows, manteniendo el mismo contrato de salida.
-- Requiere haber corrido route_patterns_and_service_windows_v1.sql antes.
...
comment on function public.buscar_viajes_0_1_transbordo_v2(
  ...
  'Version 2 del buscador de viajes con 0 o 1 transbordo. Lee patrones y ventanas de servicio GTFS-like sin cambiar el contrato de salida.';
