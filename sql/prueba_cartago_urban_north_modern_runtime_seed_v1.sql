...
with seed_routes as (
  ...
  from (
    values
      (4400::bigint, 'ida'::text, 18::integer),
      (4401::bigint, 'vuelta'::text, 18::integer),
      (4402::bigint, 'loop'::text, 22::integer),
      (4403::bigint, 'loop'::text, 22::integer),
      (4404::bigint, 'loop'::text, 24::integer),
      (4405::bigint, 'loop'::text, 24::integer),
      (4406::bigint, 'loop'::text, 24::integer),
      (4407::bigint, 'loop'::text, 24::integer),
      (4408::bigint, 'loop'::text, 24::integer),
      (4409::bigint, 'loop'::text, 24::integer),
      (4410::bigint, 'ida'::text, 20::integer),
      (4411::bigint, 'vuelta'::text, 20::integer),
      (4412::bigint, 'loop'::text, 20::integer),
      (4413::bigint, 'loop'::text, 20::integer),
      (4414::bigint, 'ida'::text, 20::integer),
      (4415::bigint, 'vuelta'::text, 20::integer),
      (4416::bigint, 'ida'::text, 18::integer),
      (4417::bigint, 'vuelta'::text, 18::integer),
      (4418::bigint, 'ida'::text, 20::integer),
      (4419::bigint, 'vuelta'::text, 20::integer),
      (4420::bigint, 'vuelta'::text, 24::integer),
      (4421::bigint, 'ida'::text, 20::integer),
      (4422::bigint, 'vuelta'::text, 20::integer),
      (4423::bigint, 'ida'::text, 20::integer),
      (4424::bigint, 'vuelta'::text, 20::integer),
      (4425::bigint, 'ida'::text, 22::integer),
      (4426::bigint, 'vuelta'::text, 22::integer)
...
preview_stops as (
  select
    sr.ruta_id,
    sr.sentido,
    concat('preview-', sr.sentido, '-', sr.ruta_id::text, '-cartago-urban-north-v1') as pattern_code,
...
select
  ...
  'importacion',
  jsonb_build_object(
    'seed_source', 'preview_cartago_urban_north_modern_v1',
...
where rp.ruta_id between 4400 and 4426
  and rp.fuente = 'importacion'
  and coalesce(rp.metadata ->> 'seed_source', '') = 'preview_cartago_urban_north_modern_v1';
...
with pattern_targets as (
  ...
  join (
    values
      (4400::bigint, 18::integer),
      (4401::bigint, 18::integer),
      (4402::bigint, 22::integer),
      (4403::bigint, 22::integer),
      (4404::bigint, 24::integer),
      (4405::bigint, 24::integer),
      (4406::bigint, 24::integer),
      (4407::bigint, 24::integer),
      (4408::bigint, 24::integer),
      (4409::bigint, 24::integer),
      (4410::bigint, 20::integer),
      (4411::bigint, 20::integer),
      (4412::bigint, 20::integer),
      (4413::bigint, 20::integer),
      (4414::bigint, 20::integer),
      (4415::bigint, 20::integer),
      (4416::bigint, 18::integer),
      (4417::bigint, 18::integer),
      (4418::bigint, 20::integer),
      (4419::bigint, 20::integer),
      (4420::bigint, 24::integer),
      (4421::bigint, 20::integer),
      (4422::bigint, 20::integer),
      (4423::bigint, 20::integer),
      (4424::bigint, 20::integer),
      (4425::bigint, 22::integer),
      (4426::bigint, 22::integer)
...
join lateral (
  values
    ('habil'::text, '05:00'::time, '09:00'::time, greatest(12, pt.frecuencia_base_min)),
    ('habil'::text, '09:00'::time, '16:00'::time, greatest(16, pt.frecuencia_base_min + 4)),
    ('habil'::text, '16:00'::time, '20:30'::time, greatest(12, pt.frecuencia_base_min)),
    ('sabado'::text, '06:00'::time, '20:00'::time, greatest(16, pt.frecuencia_base_min + 4)),
    ('domingo'::text, '07:00'::time, '19:00'::time, greatest(20, pt.frecuencia_base_min + 8)),
    ('feriado'::text, '07:00'::time, '19:00'::time, greatest(20, pt.frecuencia_base_min + 8))
