...
order by results.score asc, results.transbordos asc, results.caminata_total_m asc
...
comment on function public.buscar_viajes_0_1_transbordo_v2(
  ...
  'Planner moderno simplificado para Prueba usando route_patterns, route_pattern_stops, service_windows y transbordos.';
